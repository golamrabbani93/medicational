	...
	return (
		<div className="mb-[150px]">
			<div className="ms-12 font-bold mb-12">
				...
				<h2 className="text-accent text-4xl font-normal w-64 md:w-full">What Our Patients Says</h2>
			</div>
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  md:ps-20 justify-center items-center justify-items-center">
				{[1, 2, 3].map((testimonial) => (
					<div
						className="p-4 m-auto md:me-12 w-96 mb-10 
					"
						key={testimonial}
					>
